public class MaxDistanceOdd
{
    public static void main(String[] args)
    {
        int n = 1;                                  //Initializes n as 1.
        double maxDistance = 1 * Math.sqrt(2) / 2;  //The distance of the furthest point from the origin when n = 1.
        double numerator = 1 * Math.sqrt(2);        //The numerator of maxDistance.
        double denominator = 2;                     //The denominator of maxDistance.
        double numeratorDiff = 1 * Math.sqrt(2);    //The amount the numerator changes by when n increases by 2.
